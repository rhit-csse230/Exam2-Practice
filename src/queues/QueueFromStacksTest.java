...
/**
 * Tests the queue from two stacks code. It is the same test code as the code to
 * test the growable circular array queue, minus the comments about growing the
 * capacity, since that isn't relevant to this problem.
 * 
...
public class QueueFromStacksTest {
	...
	@Test
	public void testPeekUsingEnqueueAndDequeue() {
		// Interleaved enqueue and dequeue with peeks mixed in.
		this.intQueue.enqueue(1);
		assertEquals(1, (int) this.intQueue.peek());
		this.intQueue.enqueue(2);
		assertEquals(1, (int) this.intQueue.peek());
		this.intQueue.enqueue(3);
		this.intQueue.enqueue(4);
		this.intQueue.enqueue(5);
		assertEquals(1, (int) this.intQueue.peek());
		this.intQueue.dequeue();
		assertEquals(2, (int) this.intQueue.peek());
		this.intQueue.enqueue(6);
		this.intQueue.enqueue(7);
		this.intQueue.enqueue(8);
		assertEquals(2, (int) this.intQueue.peek());
		this.intQueue.dequeue();
		this.intQueue.dequeue();
		assertEquals(4, (int) this.intQueue.peek());
		points += 1;
	}
	...
	public static void showPoints() {
		System.out.printf("QueueFromStacks implementation earned %d/16 points\n", points);
	}
}
