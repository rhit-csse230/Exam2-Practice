...
public class Main {
	...
	public static void main(String[] args) {
		// TODO: Let Eclipse help you fix these errors by creating the required classes
		// and methods.
		...
		while (true) {
			...
			try {
				if (type.startsWith("p")) {
					System.out.println(
							"Enter a space-delimited postfix expression containing integers and operators (+-*/^): ");
					exp = scanner.nextLine();
					System.out.println(postfixEvaluator.evaluate(exp));
				} else if (type.startsWith("i")) {
					System.out.println(
							"Enter a space-delimited infix expression containing integers, parentheses, and operators (+-*/^): ");
					exp = scanner.nextLine();
