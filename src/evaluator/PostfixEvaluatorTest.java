...
public class PostfixEvaluatorTest {
	...
	public void testMultipleOps() {
		...
		assertEquals(100, this.postfixEvaluator.evaluate("6 5 + 4 * 40 - 2 ^ 2 * 4 / 2 + 10 *"));
		assertEquals(15, this.postfixEvaluator.evaluate("4 3 2 * 4 2 / 3 + + +"));
		assertEquals(16, this.postfixEvaluator.evaluate("4 3 2 * 4 2 / 3 1 + + + +"));
		points += 2;
	}
	...
	public static void tearDown() throws Exception {
		...
		// progress.
		String message = String.format("You earned %d/21 points for postfix", points);
